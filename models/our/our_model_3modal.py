...
class ourModel(BaseModel):
    ...
    def forward(self):
        ...
        # xyy:single
        # emo_fusion_feat = torch.stack((emo_feat_L, emo_feat_L, emo_feat_L), dim=0)
        ...
        # xyy:single
        # self.emo_logits_fusion, _ = self.netEmoCF(torch.cat((emo_feat_L, emo_feat_L, emo_feat_L), dim=-1))

        int_fusion_feat = torch.stack((int_feat_V, int_feat_A, int_feat_L), dim=0)
        # xyy:single
        # int_fusion_feat = torch.stack((int_feat_L, int_feat_L, int_feat_L), dim=0)
        ...
        # xyy：single
        # self.int_logits_fusion, _ = self.netIntCF(torch.cat((int_feat_L, int_feat_L, int_feat_L), dim=-1))
